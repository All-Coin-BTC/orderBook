...
export default function Sidebar() {
  return (
    <div className="sidebar-container  bg-white items-center">
      <h1 className="side-bar-header title lg:text-3xl font-extralight text-center h-14 mt-12 items-center flex justify-center">
        Activity
      </h1>
      {data.map((item) => {
        return (
